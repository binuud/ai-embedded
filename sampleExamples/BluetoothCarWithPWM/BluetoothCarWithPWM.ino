...
void controlpadWithSpeed(String direction, String speed) {
  int speedInt =  speed.toInt();
  setSpeed(speedInt);
  if (direction == "FF") moveForward();
  else if (direction == "BB") moveBackward();
  else if (direction == "LL") turnLeft();
  else if (direction == "RR") turnRight();
  else if (direction == "SS") carStop();
}
...
//   else if (rxString == "!B11:") setSpeed(40); //Serial.println("********** Start Action 1");
//   else if (rxString == "!B219") setSpeed(60); // Serial.println("********** Start Action 2");
//   else if (rxString == "!B318") setSpeed(80); // Serial.println("********** Start Action 3");
//   else if (rxString == "!B417") setSpeed(100); // Serial.println("********** Start Action 4");
...
class MyCallbacks : public BLECharacteristicCallbacks {
  void onWrite(BLECharacteristic *pCharacteristic) {
    ...
    if (rxValue.length() > 3) {
      String direction = rxValue.substring(0, 2);
      String speed = rxValue.substring(3);
      Serial.printf("Received Value %s %s \n", direction, speed);
      controlpadWithSpeed(direction, speed);
    }
  }
};
